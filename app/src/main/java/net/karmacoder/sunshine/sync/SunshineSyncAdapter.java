package net.karmacoder.sunshine.sync;
...
import net.karmacoder.sunshine.activities.MainActivity;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                buildNotification(contentTitle, contentText, iconId);
    ...
    private void buildNotification(String title, String text, @DrawableRes int iconId) {
        final Context context = getContext();
        final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        final String key = context.getString(R.string.preference_enable_notification_key);
        final boolean defaultValue = context.getResources().getBoolean(R.bool.preference_enable_notification_default);
        final boolean notificationsEnabled = prefs.getBoolean(key, defaultValue);
